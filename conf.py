...
BLOG_AUTHOR = "Shane Rogers"  # (translatable)
BLOG_TITLE = "My Clojure Journey"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://swrogers.github.io/learning-clojure/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://swrogers.github.io/learning-clojure/"
BLOG_EMAIL = "swrogers@gmail.com"
BLOG_DESCRIPTION = "Documenting my journey to teach myself clojure."  # (translatable)
